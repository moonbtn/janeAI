...
export type ContentStyle = 'announcement' | 'story_telling' | 'benefit_focus' | 'seeding' | 'trending_funny' | 'opinion_hook' | 'relatable_scenario' | 'insider_drop' | 'english_announcement'
